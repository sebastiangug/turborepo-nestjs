...
const nest_config_1 = __webpack_require__(8);
const apollo_1 = __webpack_require__(15);
const root_resolver_1 = __webpack_require__(16);
...
const common_1 = __webpack_require__(6);
const app_config_1 = __webpack_require__(10);
const auth_config_1 = __webpack_require__(12);
let MyConfigService = class MyConfigService {
    constructor() {
        this.appConfig = new app_config_1.AppConfig();
        this.authConfig = new auth_config_1.AuthConfig();
        this.configs = {
            ...this.appConfig,
            ...this.authConfig,
        };
    ...
    get(key) {
        if (process.env[`CONFIG_${String(key)}`]) {
            let config = process.env[`CONFIG_${String(key)}`];
            try {
...
const environment_config_1 = __webpack_require__(11);
class AppConfig {
    constructor() {
        this.CORS_ORIGINS = () => {
            switch (process.env.ENVIRONMENT) {
                case environment_config_1.Environments.development:
                    return this.DEV_CORS_ORIGINS;
                case environment_config_1.Environments.staging:
                    return this.STAGE_CORS_ORIGINS;
                case environment_config_1.Environments.production:
                    return this.PROD_CORS_ORIGINS;
                default:
                    return this.DEFAULT_CORS_ORIGINS;
            }
        };
        this.DEV_CORS_ORIGINS = ["*"];
        this.STAGE_CORS_ORIGINS = [];
        this.PROD_CORS_ORIGINS = [];
        this.DEFAULT_CORS_ORIGINS = ["*"];
    }
}
...
MyConfigModule = __decorate([
    (0, common_1.Module)({
        providers: [config_service_1.MyConfigService],
        exports: [config_service_1.MyConfigService],
    })
], MyConfigModule);
